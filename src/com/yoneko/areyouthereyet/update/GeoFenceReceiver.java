...
public class GeoFenceReceiver extends BroadcastReceiver {
    ...
    public static String SMS_MESSAGE_OUT_TEXT = "Hi Baby, I'm leaving my house now!!!! ";// +
    // String.valueOf(MainActivity.RADIUS_METER);
    ...
    private SimpleGeofence getSimpleGeofence(List<SimpleGeofence> list,
            Geofence g) {
        ...
        for (SimpleGeofence geo : list) {
            ...
            if (geo.getId().equals(g.getRequestId())) {
                ...
                // if the dateLastSent is > 0 , add 15 minutes to the date then
                // compare the times to dateTime.now.
                // if the date lastsent + threshold minutes is > dateTime now
                // then you should send it
                if (geo.getLastSent() == -1
                        || geo.getLastSent()

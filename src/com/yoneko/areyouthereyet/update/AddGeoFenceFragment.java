...
/**
 * A simple {@link android.support.v4.app.Fragment} subclass. Activities that contain this fragment must implement the {@link
 * AddGeoFenceFragment.onDialogDismissed} interface to handle interaction events. Use the {@link AddGeoFenceFragment#newInstance} factory method to create an
...
//		toggle_switch.setChecked(true);
    ...
    protected SimpleGeofence getItemInGeoFenceList(SimpleGeofence item) {
        ...
        for (int i = 0; i < cachedList.getGeoFences().size(); i++) {
            ...
            if ((item.getTitle() != null && currentGeofence.getTitle() != null) && item.getLatitude() == currentGeofence.getLatitude()
